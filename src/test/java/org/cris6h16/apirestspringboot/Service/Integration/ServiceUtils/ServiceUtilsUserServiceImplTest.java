...
//
//    /**
//     * test the exception raised in {@link UserServiceImpl#create(CreateUserDTO)}
//     * when it's called with a {@link CreateUserDTO} null.
//     *
//     * <p>
...
//     * <br>
//     * [{@code message}={@link Cons.User.DTO#ANY_RELATED_DTO_WITH_USER_NULL},{@code recommendedStatus}={@link HttpStatus#BAD_REQUEST}]
//     * </p>
//     *
//     * @author <a href="https://www.github.com/cris6h16" target="_blank">Cristian Herrera</a>
//     * @since 1.0
...
//
//    /**
//     * test the unexpected exception raised in {@link UserServiceImpl#create(CreateUserDTO)}
//     *
//     * <p>
//     * then the exception threw should be:
//     * <br>
...
//
//    /**
//     * create a valid {@link CreateUserDTO} <br>
//     *
...
//     * when {@link UserServiceImpl#update(Long, CreateUserDTO)} is called
...
//        // Arrange
//        Long id = 1L;
//        CreateUserDTO dto = createValidDTO();
//
//        // Act & Assert
...
//
//    /**
//     * test the exception raised in {@link UserServiceImpl#update(Long, CreateUserDTO)}
//     * when it's called with a {@link CreateUserDTO} null.
//     *
//     * <p>
//     * then the exception threw should be:
...
//    /**
//     * test the exception raised in {@link UserServiceImpl#update(Long, CreateUserDTO)}
//     * when it's called with a {@link CreateUserDTO#getPassword()} less than 8 characters.
//     *
//     * <p>
//     * then the exception threw should be:
//     * <br>
...
//
//        CreateUserDTO updatePasswordDTO = CreateUserDTO.builder()
//                .password("1234567")
//                .build();
//
//        // Act & Assert
...
//
//    /**
//     * test an unexpected exception raised in {@link UserServiceImpl#update(Long, CreateUserDTO)}
//     *
//     * <p>
//     * then the exception threw should be:
//     * <br>
...
//        userRepository.saveAndFlush(original);
//
//        CreateUserDTO thrower = new CreateUserDTO() {
//            @Override
...
//     * when {@link UserServiceImpl#create(CreateUserDTO)} is called violating
