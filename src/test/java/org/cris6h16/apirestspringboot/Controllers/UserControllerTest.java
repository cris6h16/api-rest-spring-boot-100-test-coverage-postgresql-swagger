...
// * on the {@link UserController#create(CreateUserDTO)} which isn't necessary be authenticated
...
//
//    /**
//     * Test the successful behavior of {@link UserController#create(CreateUserDTO)}
//     *
//     * @author <a href="https://www.github.com/cris6h16" target="_blank"> Cristian Herrera </a>
//     * @since 1.0
//     */
...
//        when(userService.create(any(CreateUserDTO.class))).thenReturn(1L);
//
...
//
//    /**
//     * Test the successful behavior of {@link UserController#update(Long, CreateUserDTO)}
//     *
//     * @author <a href="https://www.github.com/cris6h16" target="_blank"> Cristian Herrera </a>
//     * @since 1.0
//     */
...
//        doNothing().when(userService).update(any(Long.class), any(CreateUserDTO.class));
//
