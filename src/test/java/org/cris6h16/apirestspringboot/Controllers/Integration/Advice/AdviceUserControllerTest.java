...
//     *
//     * @author <a href="https://www.github.com/cris6h16" target="_blank"> Cristian Herrera </a>
//     * @implNote Used method: {@link UserController#create(CreateUserDTO)} is {@code permitAll()}.
//     * @since 1.0
//     */
//    @Test
...
//                .thenThrow(new UserServiceTransversalException(Cons.User.DTO.ANY_RELATED_DTO_WITH_USER_NULL, HttpStatus.BAD_REQUEST)); // handled random exception
//
...
//                .andExpect(jsonPath("$.message").value(Cons.User.DTO.ANY_RELATED_DTO_WITH_USER_NULL));
//    }
//
//    /**
...
//     * Method: {@link UserController#update(Long, CreateUserDTO)}
//     * </p>
//     *
//     * @implNote Endpoint method depends {@code principal.id} then {@link WithMockUserWithId}
//     * @author <a href="https://www.github.com/cris6h16" target="_blank"> Cristian Herrera </a>
