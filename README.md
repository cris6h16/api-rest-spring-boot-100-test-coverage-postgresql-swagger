...
| Passing a [CreatedUserDTO](src/main/java/org/cris6h16/apirestspringboot/DTOs/CreateUserDTO.java) with a:                                                                                                                                                                                                                                                 | RESPONSE                                                                                                                                                                                                                                                                                                                   | STATUS CODE                 | HEADER ADDED DUE VISUALIZATION CUT |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|------------------------------------|
| - `username` that already exists<br/>- `email` that already exists                                                                                                                                                                                                                                                                                       | - `Username already exists`<br/>- `Email` already `exists`                                                                                                                                                                                                                                                                 | `409 Conflict`              |                                    |
| - `password` length less than 8<br/>- `username` length greater than `20`<br/>- `email` that isn't valid<br/>- `email` that is null<br/>- `email` that has just white spaces<br/>- `username` that is null<br/>- `username` that has just white spaces<br/>- `password` that is null<br/>- `String` in `PathVariable`, this is not the datatype required | - `Password must be at least 8 characters`<br/>- `Username must be less than 20 characters`<br/>- `Email is invalid`<br/>- `Email is required`<br/>- `Email is required`<br/>- `Username mustn't be blank`<br/>- `Username mustn't be blank`<br/>- `Password mustn't be blank`<br/>- `The datatype passed by you is wrong` | `400 Bad Request`           |                                    |
