...
|-------------------------------------------------------------------------------------------------------|--------------------|
| - _Username already exists_<br/>- _Email already exists_                                              | `409 Conflict`     |
| - _You need to be authenticated to perform this action_<br/>- _You cannot updated other user Account_ | `401 Unauthorized` |
| - _Password must be at least 8 characters_<br/>- _Email is invalid_<br/>- _Username mustn't be blank_ | `400 Bad Request`  |
...
| 2024-05-01                | [shouldNotCreateAUser_UsernameIsNullOrEmpty()]()<br/>[shouldNotCreateAUser_PasswordTooShort()]()<br/>[shouldNotCreateAUser_PasswordIsNullOrEmpty]()<br/>[shouldNotCreateAUser_EmailIsNullOrEmpty]()<br/> Investigating & analyzing why some data constraints aren't  respected<br/> and find a way to handle better the exceptions (response body) <br/>Correct all responses (standardize the errors responses)<br/> [see that](#things-that-cause-me-troublesgit ) | 16:55           | 20:10           | 
| 2024-05-03                | Add/Improve docs/comments                                                                                                                                                                                                                                                                                                                                                                                                                                            | 17:25           | 17:48           |
|                           |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |                 |                 |
| 2024-05-03                | [shouldCreateAUser()](src/test/java/org/cris6h16/apirestspringboot/Controllers/UserControllerTest.java)                                                                                                                                                                                                                                                                                                                                                              | 18:06           |                 |
