...
Developing with TDD ensure the coverage of "all" possible code which are coverable, in this case mainly the Controllers, is also necessary write test for boundary cases in the `@Service` (just an example).
...
like errors in the database, transactions, etc. these mentioned can also provide a more descriptive message writing explicitly
