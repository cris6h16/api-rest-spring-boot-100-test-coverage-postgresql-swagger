...
| FAIL                                                                                           | RESPONSE           |
|------------------------------------------------------------------------------------------------|--------------------|
| - _Title is required ~~(only spaces or null)~~_<br/>- _Title must be less than 255 characters_ | `400 Bad Request`  |
| - _You need to be authenticated to perform this action_                                        | `401 Unauthorized` |
...
| 2024-05-05 <br/><br/>                    | Adding  Test(CREATE A NOTE): [shouldCreateANote()](src/test/java/org/cris6h16/apirestspringboot/Controllers/NoteControllerTest.java) <br/>&& correct security issues in [MyAuthorizationService](src/main/java/org/cris6h16/apirestspringboot/Config/Service/CustomAuthHandler/MyAuthorizationService.java)             <br/>              [shouldNotCreateANoteTitleIsRequired()]()                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | 8:20             <br/><br/>11:37 | 10:20<br/><br/>12:05          |
